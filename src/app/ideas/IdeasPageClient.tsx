...
import { archiveIdea, buildIdea, fetchIdeas, generateIdea } from '../shared/api/client';
import { IdeasApp } from '../shared/components/IdeasApp';
import type { IdeasBaseGameOption, IdeasIdea, IdeasPageData } from '../shared/types';
